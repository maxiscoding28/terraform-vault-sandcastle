# Vault Sandcastle
<p align="center">
<img src="https://raw.githubusercontent.com/maxiscoding28/terraform-vault-sandcastle/main/logo.png">
</p>
...
## Quick Start
  ...
  - **Step 1**
    ...
    - Retrieve the Public DNS name for the created EC2 instance:
      ...
      - _Via aws cli_: run the following command and copy the value for `DNS NAME`:
        ```
...
## Consul Mode
  ...
  - **Step 2**
    - Run `terraform apply`
    - Type `yes` and hit enter.
    - **Note**: Set `desired_capacity` to zero and run a `terraform apply` before setting this variable. 
    Otherwise [you're going to have a bad time](https://media1.tenor.com/m/6tWDOf4cxmUAAAAC/south-park.gif).
